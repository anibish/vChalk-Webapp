...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'cureivzn_lpts',
      'username' => 'cureivzn_lpts',
      'password' => '2Sw-RWP42(',
      'host' => 'localhost',
      'port' => '',
      'driver' => 'mysql',
 ...
 *
 */
$drupal_hash_salt = 'ysvsaiuvsuqwup0zzbs499lrnyngkinhvoffujdt9ea';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_vchalklpts_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_vchalklpts_dd.inc';
}
// </DDSETTINGS>
